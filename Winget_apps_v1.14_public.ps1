...
#Start logging
Start-Transcript -Path "C:\Intune\Winget\winget_install_apps_v1.14.log"
...
#Reset source
Start-Process -FilePath $winget -NoNewWindow -Wait -ArgumentList 'source reset --force --verbose-logs' > C:\Intune\Winget\Winget-source-reset.log
Start-Sleep -Seconds 15
#Upgrade Winget source
Start-Process -FilePath $winget -NoNewWindow -Wait -ArgumentList 'source update' > C:\Intune\Winget\Winget-source-update.log
Start-Sleep -Seconds 15
#Install 7zip with Winget
Start-Process -FilePath $winget -NoNewWindow -Wait -ArgumentList 'install 7zip.7zip --silent --accept-package-agreements --accept-source-agreements' > C:\Intune\Winget\Winget-install-7zip.log
Start-Sleep -Seconds 15
#Install VLC player with Winget
Start-Process -FilePath $winget -NoNewWindow -Wait -ArgumentList 'install VideoLAN.VLC --silent --accept-package-agreements --accept-source-agreements' C:\Intune\Winget\Winget-install-VLC.log
Start-Sleep -Seconds 15
#Stop logging
Stop-Transcript
#Create detection method
New-Item "C:\Intune\Winget\winget_install_apps_end_v1.14.txt" -ItemType File -Value "Winget Application installer"