...
#Start logging
Start-Transcript -Path "C:\Intune\Winget\winget_install_apps_v1.16.log"
...
New-Item "C:\Intune\Winget\winget_install_apps_end_v1.16.txt" -ItemType File -Value "Winget Application installer"